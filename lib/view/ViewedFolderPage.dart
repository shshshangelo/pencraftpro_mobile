...
class ViewedFolderPage extends StatefulWidget {
  final String title;
  ...
  @override
  State<ViewedFolderPage> createState() => _ViewedFolderPageState();
}

class _ViewedFolderPageState extends State<ViewedFolderPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Add debug prints
    print('ViewedFolderPage - contentJson: ${widget.contentJson}');
    print('ViewedFolderPage - fontFamily: ${widget.fontFamily}');

    return Scaffold(
      appBar: AppBar(
        title: Text(
          'View Mode Only - Folder',
