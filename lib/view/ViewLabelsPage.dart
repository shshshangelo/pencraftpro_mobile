...
class ViewLabelPage extends StatefulWidget {
  final String title;
  ...
  @override
  State<ViewLabelPage> createState() => _ViewLabelPageState();
}

class _ViewLabelPageState extends State<ViewLabelPage> {
