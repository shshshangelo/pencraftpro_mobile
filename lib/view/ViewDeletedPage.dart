// ignore_for_file: dead_code, deprecated_member_use, unused_local_variable
...
class ViewDeletedPage extends StatefulWidget {
  final String title;
  ...
  @override
  State<ViewDeletedPage> createState() => _ViewDeletedPageState();
}

class _ViewDeletedPageState extends State<ViewDeletedPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print('ViewDeletedPage - contentJson: ${widget.contentJson}');
    print('ViewDeletedPage - fontFamily: ${widget.fontFamily}');
    print('ViewDeletedPage - widget: $widget');
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'View Mode Only - Deleted',
